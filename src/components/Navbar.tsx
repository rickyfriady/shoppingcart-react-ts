...
export function Navbar() {
  ...
  return (
    <header aria-label="Site Header" className="bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-end">
          <nav aria-label="Site Nav" className="hidden lg:flex lg:gap-4 lg:text-xs lg:font-bold lg:uppercase lg:tracking-wide lg:text-gray-500">
            <a href="/store" className="block h-16 border-b-4 border-transparent leading-[4rem] hover:border-current hover:text-red-700">
              Products
            </a>
      ...
      {isClick && (
        <div id="drawer-right-example" className="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-80 dark:bg-gray-800 transform-none" tabIndex={-1} aria-labelledby="drawer-right-label">
