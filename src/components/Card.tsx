...
function Card({ id, name, price, imgUrl }: StoreItemsProbs) {
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
        <div className="h-[300px] aspect-square rounded-lg overflow-hidden group relative hover:scale-95 duration-700 transition-all">
          <img className="w-full h-full object-cover  group-hover:scale-125 group-hover:rotate-12 transition-all duration-700" src={imgUrl} />
        </div>
