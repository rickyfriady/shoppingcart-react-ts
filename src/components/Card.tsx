          ...
          <div className="flex items-center justify-between ">
            ...
            {quantity === 0 ? (
              ...
              <div className="flex justify-center items-center flex-col gap-5">
                ...
                <div>
                  <button className="text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-rose-600 dark:hover:bg-rose-700 focus:outline-none dark:focus:ring-rose-800">
                    Remove
                  </button>
                </div>
              </div>
